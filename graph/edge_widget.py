...
class EdgeWidget(Widget):
    ...
    def getIsDirected(self):
        return globals.graph_manager.isDirected
    ...
    def getTrianglePoints(self):
        ...
        r2 = 50
        points.append(dest_x - r2 * cos_p2 + globals.node_radius / 2)
        points.append(dest_y - r2 * sin_p2 + globals.node_radius / 2)

        cos_p3 = cosine * cos(pi / 12) - sine * sin(pi / 12)
        sin_p3 = sine * cos(pi / 12) + sin(pi / 12) * cosine

        points.append(dest_x - r2 * cos_p3 + globals.node_radius / 2)
        points.append(dest_y - r2 * sin_p3 + globals.node_radius / 2)
